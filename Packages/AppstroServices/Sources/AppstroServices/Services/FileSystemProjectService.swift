...
public final class FileSystemProjectService: ProjectService {
	...
	public func ensureAppstroDirectory(at root: URL) throws -> URL {
	...
	public func ensureReleaseDirectory(at root: URL, version: String) throws -> URL {
		let appstroURL = try ensureAppstroDirectory(at: root)
	...
	public func build(at root: URL, config: AppstroConfig, version: String, buildNumber: String) async throws -> URL {
		...
		let releaseDir = try ensureReleaseDirectory(at: root, version: version)
